...
# About.xml declares with loadBefore. The first scenario asserts that declaration in the running game; the
# three others assert its effect, through ThingDef.AllRecipes, which is what the health tab reads.
#
